# -*- coding: utf-8 -*-
"""
train_nn.py - Experiment 2: Novel Viruses
End-to-end MambaCross neural network trainer for Experiment 2 (Novel Viruses).
"""
import os
import sys
import json
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train ESM-Mamba on Experiment 2 (Novel Viruses)")
